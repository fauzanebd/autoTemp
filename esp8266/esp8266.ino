...
#define rx_pin D5
#define tx_pin D6
SoftwareSerial NodeSerial(rx_pin,dx_pin); // RX | TX
...
//          
      if (index == 2){
        ...
        static char actemp = arr[2];
        static char roomtemp = arr[1];
        static char people = arr[0];
      }
//          
    }
  }
  delay(500);
  return actemp,roomtemp,people;
}
...
void loop(){
  actemp,roomtemp,people = getDataFromNano();
